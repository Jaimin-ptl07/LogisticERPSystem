"""
Audit Client for sending audit events to Company Service
"""
import logging
...
class AuditContext:
    """
    Context manager for audit client

    Usage:
        async with AuditContext(auth_headers) as audit:
    ...
    async def __aenter__(self):
        self.client = AuditClient(self.auth_headers)
        return self.client
