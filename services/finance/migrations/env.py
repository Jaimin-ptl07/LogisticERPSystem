"""
Alembic Environment Configuration for Finance Service
...
# Import from src.models where models are actually defined
...
def get_database_url() -> str:
    ...
    # Service-specific database name for Finance service
    db_name = os.getenv("POSTGRES_FINANCE_DB", "finance_db")
