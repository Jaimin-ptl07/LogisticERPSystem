...
# Import from src.models to avoid importing database.py which calls get_settings()
...
def get_database_url() -> str:
    ...
    # Service-specific database name for notification service
    db_name = os.getenv("POSTGRES_NOTIFICATION_DB", "notification_db")
