...
export const GET = createApiRoute(COMPANY_API_URL, 'vehicles/[id]/')
export const PUT = createApiRoute(COMPANY_API_URL, 'vehicles/[id]/')
export const DELETE = createApiRoute(COMPANY_API_URL, 'vehicles/[id]/')