/**
 * Proxy API route for individual customer operations
...
export const GET = createApiRoute(COMPANY_API_URL, 'customers/[id]/')
export const PUT = createApiRoute(COMPANY_API_URL, 'customers/[id]/')
export const DELETE = createApiRoute(COMPANY_API_URL, 'customers/[id]/')