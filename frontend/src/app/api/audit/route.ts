/**
 * Proxy API route for audit logs
...
export const GET = createApiRoute(COMPANY_API_URL, 'api/v1/audit-logs')
export const POST = createApiRoute(COMPANY_API_URL, 'api/v1/audit-logs')
