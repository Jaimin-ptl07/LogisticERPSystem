...
export default function ProductsPage() {
  ...
  const handleEdit = (id: string) => {
    router.push(`/masters/products/${id}/edit`);
  };

  const handleView = (id: string) => {
    router.push(`/masters/products/${id}`);
  };
  ...
  return (
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-3">
            <Button
              variant="outline"
              onClick={() => router.push('/masters/products/categories')}
              className="flex items-center gap-2"
            >
              <Tag className="w-4 h-4" />
              Manage Categories
            </Button>
            <Button onClick={() => router.push('/masters/products/new')} className="flex items-center gap-2">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-600">
                    ${products.reduce((sum, p) => sum + (p.current_stock * p.unit_price), 0).toLocaleString()}
                  </p>
                </div>
                          ...
                          <TableCell>
                            <div className="flex items-center space-x-2">
                              ...
                              <span className="text-sm">
                                {product.current_stock} / {product.max_stock_level || 0}
                              </span>
