    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            {statusBadge}
            <Button onClick={() => router.push(`/masters/customers/${customerId}/edit`)}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div>
                ...
                <div className="mt-1">{getBusinessTypeBadge(customer.business_type || '')}</div>
              </div>
              <div>
                <label className="text-sm font-medium text-gray-500">Pricing Tier</label>
                <p className="text-gray-900">{customer.pricing_tier || 'Standard'}</p>
              </div>
              <div>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div>
                <label className="text-sm font-medium text-gray-500">Home Branch</label>
                <p className="text-gray-900">{customer.home_branch?.name || 'Not assigned'}</p>
              </div>
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-gray-900">Order #ORD-002 created</p>
                  ...
                  <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-gray-900">Payment received for INV-2024-001</p>
                  ...
                  <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-gray-900">Customer information updated</p>
                  ...
                  <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium text-gray-900">Order #ORD-001 delivered successfully</p>
