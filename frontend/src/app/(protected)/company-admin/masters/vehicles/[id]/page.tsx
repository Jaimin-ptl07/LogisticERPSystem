...
export default function VehicleDetailsPage() {
      ...
      <div className="p-6">
        <div className="bg-red-50 border border-red-200 rounded-lg p-4">
          ...
          <p className="text-red-600 text-sm mt-1">
            The vehicle may not exist or you don't have permission to view it
          </p>
        </div>
      </div>
    );
  ...
  const getMaintenanceStatus = () => {
    if (!vehicle.next_maintenance)
      return { status: "none", message: "No maintenance scheduled" };
    ...
    if (daysUntilMaintenance < 0) {
      ...
      return {
        status: "scheduled",
        message: `Next maintenance in ${daysUntilMaintenance} days`,
      };
    }
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          {statusBadge}
          <Button
            onClick={() => router.push(`/masters/vehicles/${vehicleId}/edit`)}
          >
