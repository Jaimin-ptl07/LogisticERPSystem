    ...
    <AppLayout>
      <div className="p-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-2">Manage order approvals and financial operations</p>
        </div>
                    ...
                    {order.approval_status === 'approved' && (
                      <div className="mt-4 p-3 bg-green-50 rounded-lg">
                        <p className="text-sm text-green-800">
                          Approved on {new Date(order.finance_approved_at || '').toLocaleDateString()}
                        </p>
                      </div>
                    )}
                    ...
                    {order.approval_status === 'rejected' && (
                      <div className="mt-4 p-3 bg-red-50 rounded-lg">
                        <p className="text-sm text-red-800">
                          Rejected: {order.approval_reason || 'No reason provided'}
                        </p>
                      </div>
                    )}
                  </div>
